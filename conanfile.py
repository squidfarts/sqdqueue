...
class PackageConan(ConanFile):
    ...
    url = 'https://github.com/squidfarts/sqdqueue.git'
    description = 'Queue colletion by Squidfarts.'
    ...
    def package(self):
        ...
        self.copy('*sqdqueue.lib', dst='lib', keep_path=False)
